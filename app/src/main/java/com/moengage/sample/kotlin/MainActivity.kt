...
class MainActivity : AppCompatActivity(), OnMessageClickListener, OnHomeCategorySelected {
    ...
    private fun initView() {
        ...
        binding.btSaveUser.setOnClickListener {
            ...
            MoEHelper.getInstance(applicationContext).setFirstName(name)
            MoEHelper.getInstance(applicationContext).setFullName(name)
            MoEHelper.getInstance(applicationContext).setEmail("ngocthaihn4@gmail.com.vn")
            MoEHelper.getInstance(applicationContext).setUniqueId("ngocthaihn4@gmail.com.vn")
        }

        binding.btTrackEvent.setOnClickListener {
            val properties = Properties()
            properties.addAttribute("quantity", 69)
